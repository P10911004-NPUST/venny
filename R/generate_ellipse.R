...
#'
#' @param data A named list with length of 3.
...
#'     Set_C = sample(s, 700)
#' )
#' out <- generate_ellipse_3(venn_list)
#' out$plot
generate_ellipse_3 <- function(
        ...
        a = c(1, 1, 1),
        b = c(1, 1, 1),
        ellipse_angle = c(0, 0, 0),
        ellipse_density = c(100, 100, 100),
        ellipse_line_color = rep("transparent", 3),
        ellipse_line_width = 0,
        ellipse_fill_color = c("#D55E00", "#009E73", "#56B4E9"),
        ...
        set_label_family = rep("sans", times = 3),
        set_label_size = rep(5, times = 3),
        set_label_face = rep("bold", times = 3),
        set_label_color = c("#D55E00", "#009E73", "#56B4E9"),
        ...
        zone_label_family = rep("sans", times = 7),
        zone_label_size = rep(3, times = 7),
        zone_label_face = rep("bold.italic", times = 7),
        zone_label_color = rep("black", times = 7),
        zone_label_angle = rep(0, times = 7),
        ## Zone count ================================================
        ...
        zone_count_hjust = 0,
        zone_count_vjust = 0,
        zone_count_family = rep("sans", times = 7),
        zone_count_size = rep(4, times = 7),
        zone_count_face = rep("plain", times = 7),
        zone_count_color = rep("grey30", times = 7),
        zone_count_angle = rep(0, times = 7),
        ## Zone percentage ===============================================
        ...
        zone_percentage_family = rep("sans", times = 7),
        zone_percentage_size = rep(3.5, times = 7),
        zone_percentage_face = rep("plain", times = 7),
        zone_percentage_color = rep("grey40", times = 7),
        zone_percentage_angle = rep(0, times = 7)
) {
...
#' 5. Elements for each subsets
#'
#' @param data A named list with length of 4.
#' @param x0 The x coordinates for the center points of the ellipses (default: c(-1.1, 0, 0, 1.1)).
#' @param y0 The y coordinates for the center points of the ellipses (default: c(-.6, 0, 0, -.6)).
#' @param a The length of the long arm of the ellipses (default: c(2.5, 2.5, 2.5, 2.5)).
#' @param b The length of the short arm of the ellipses (default: c(1.35, 1.2, 1.2, 1.35)).
...
generate_ellipse_4 <- function(
        ...
        zone_percentage_color = rep("grey40", times = 15),
